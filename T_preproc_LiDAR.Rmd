...
Click on the *Connect to folder* button in upper right corner and navigate to the folder containing the toolbox. Select the file *LAStool.tbx* and press open. 
