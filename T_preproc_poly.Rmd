...
Then click the *Edit* button and specify the **Spatial Reference**. Find for *RD_New* in the European projections, see image below for the screen in which this should be done.
